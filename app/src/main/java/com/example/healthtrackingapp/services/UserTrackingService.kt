...
import com.example.healthtrackingapp.utils.Constants.FASTEST_LOCATION_INTERVAL
import com.example.healthtrackingapp.utils.Constants.LOCATION_UPDATE_INTERVAL
import com.example.healthtrackingapp.utils.Constants.NOTIFICATION_CHANNEL_ID
import com.example.healthtrackingapp.utils.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.healthtrackingapp.utils.Constants.NOTIFICATION_ID
...
@AndroidEntryPoint
class UserTrackingService : LifecycleService() {
    ...
    private fun updateLocationTracking(isTracking: Boolean) {
        if(isTracking) {
            if(UserPermissionTracking.hasLocationPermissions(this)) {
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean) {
        ...
        val pendingIntent = if(isTracking) {
            val pauseIntent = Intent(this, UserTrackingService::class.java).apply {
                action = ACTION_PAUSE_SERVICE
            }
            PendingIntent.getService(this, 1, pauseIntent, FLAG_UPDATE_CURRENT)
        } else {
            val resumeIntent = Intent(this, UserTrackingService::class.java).apply {
    ...
    private fun startForegroundService() {
        ...
        timeRunInSeconds.observe(this, Observer {
            val notification = curNotificationBuilder
                .setContentText(UserPermissionTracking.getFormattedStopWatchTime(it * 1000L))
